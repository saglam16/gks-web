...
export const metadata: Metadata = {
  title: "Plankote ve Aplikasyon - GKS Harita Mühendislik",
  description: "Hassas plankote ölçümleri ve aplikasyon hizmetleri",
};

export default function PlankotePage() {
  const content = getServiceContent('plankote');
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
            <div className="text-white text-center max-w-3xl px-4">
              <p className="text-xl mb-4">
                Hassas Plankote Ölçümleri ve Aplikasyon Hizmetleri
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-12">
            <p className="text-lg mb-4">
              Plankote ve aplikasyon hizmetlerimiz hakkında detaylı bilgi ve fiyat teklifi için bize ulaşın.
            </p>
