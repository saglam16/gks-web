...
export const metadata: Metadata = {
  title: "CBS (GIS) Hizmetleri - GKS Harita Mühendislik",
  description: "Modern Coğrafi Bilgi Sistemleri ile veri yönetimi ve analiz çözümleri",
};

export default function CBSPage() {
  const content = getServiceContent('cbs');
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
            <div className="text-white text-center max-w-3xl px-4">
              <p className="text-xl mb-4">
                Modern Coğrafi Bilgi Sistemleri ile Veri Yönetimi ve Analiz Çözümleri
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-12">
            <p className="text-lg mb-4">
              CBS projeleriniz için detaylı bilgi ve fiyat teklifi almak için bize ulaşın.
            </p>
