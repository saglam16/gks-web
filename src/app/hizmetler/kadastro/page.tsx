...
export const metadata: Metadata = {
  title: "Kadastro Ölçümleri - GKS Harita Mühendislik",
  description: "Profesyonel kadastro ölçüm ve haritalandırma hizmetleri",
};

export default function KadastroPage() {
  const content = getServiceContent('kadastro');
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
            <div className="text-white text-center max-w-3xl px-4">
              <p className="text-xl mb-4">
                Profesyonel Kadastro Ölçüm ve Haritalandırma Hizmetleri
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-12">
            <p className="text-lg mb-4">
              Kadastro ölçüm hizmetlerimiz hakkında detaylı bilgi ve fiyat teklifi için bize ulaşın.
            </p>
